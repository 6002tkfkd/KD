...
class LitAcousticSceneClassificationSystem(L.LightningModule):
    ...
    def __init__(self,
        ...
        self.test_f1 = F1Score(task="multiclass", num_classes=self.number_of_classes, average="macro")
        self.test_precision = Precision(task="multiclass", num_classes=self.number_of_classes, average="macro")
        self.test_recall = Recall(task="multiclass", num_classes=self.number_of_classes, average="macro")
    ...
    def test_step(self, batch, batch_idx):
        ...
        preds = torch.argmax(y_hat, dim=1)  # 예측 라벨
        self.test_f1.update(preds, y)       # F1 스코어에 배치 데이터 반영
    ...
    def on_test_epoch_end(self):
        ...
        print(f"\nTest F1 Score: {f1_score.item():.4f}")
